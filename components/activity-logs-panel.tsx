...
export function ActivityLogsPanel() {
  ...
  useEffect(() => {
    console.log("Setting up activity logs listener");
  ...
  useEffect(() => {
    ...
    if (filterType !== "all") {
      filtered = filtered.filter(
        (activity) => activity.activityType === filterType
      );
    }
        ...
        <div className="rounded-lg border bg-muted/30 p-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <Select
              ...
              onValueChange={(v) => setLimitCount(Number.parseInt(v))}
            >
            ...
            {filteredActivities.length === 0 ? (
              ...
              filteredActivities.map((activity) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`mt-0.5 rounded-full p-2 bg-muted ${colorClass}`}
                    >
