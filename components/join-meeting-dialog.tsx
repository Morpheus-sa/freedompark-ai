...
import {
  formatMeetingCode,
  isValidMeetingCode,
} from "@/lib/meeting-code-generator";
...
export function JoinMeetingDialog({
  ...
  const joinMeeting = async () => {
    ...
    console.log(" Attempting to join with code/ID:", codeOrId);
    ...
    try {
      ...
      toast({
        ...
        description:
          error.message ||
          "Failed to join meeting. Check your code and try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the meeting code or ID to join an existing meeting
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Enter either a meeting code (ABCD-1234) or full meeting ID
            </p>
          </div>
          <Button
            onClick={joinMeeting}
